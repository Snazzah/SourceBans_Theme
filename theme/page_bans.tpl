...
<br />
<div id="banlist-nav"><a href="index.php?p=banlist&hideinactive={if $hidetext == 'Hide'}true{else}false{/if}{$searchlink|htmlspecialchars}" title="{$hidetext} inactive">{$hidetext} inactive</a> | <i>Total Bans: <span id='total_ban_bot'>{$total_bans}</span></i></div>
<div id="banlist">
        ...
        <td colspan="7" align="center">
          <div class="opener"> 
              ...
              <tr align="left">
								...
								<td height="16" class="listtable_1" id="found_the_invok">{$ban.ban_date}</td>
					        </tr>
					        <tr align="left">
					            <td width="20%" height="16" class="listtable_1">Banlength</td>
					            <td height="16" class="listtable_1" id="found_the_length">{$ban.banlength}</td>
					        </tr>
							{if $ban.unbanned}
							<tr align="left">
							...
							<tr align="left">
								...
								<td height="16" class="listtable_1" id="found_the_reason">{$ban.reason|escape:'html'}</td>
							</tr>
							{if !$hideadminname}
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Banned by Admin</td>
								<td height="16" class="listtable_1" id="found_the_admin">
									{if !empty($ban.admin)}
										{$ban.admin|escape:'html'}
									{else}
										<i><font color="#677882">Admin deleted.</font></i>
